  ...
  "check and rewrite for the endpoint yaml file" when {
    ...
    "the yaml summary is ready to be rewritten" should {
      ...
      "return the rewritten summary when it contains square brackets" in {
        val result = rewrite("", "", "summary: Create and Amend employment expenses [square bracket test]")
        result shouldBe """summary: "Create and Amend employment expenses [square bracket test] [test only]""""
      }
    }
